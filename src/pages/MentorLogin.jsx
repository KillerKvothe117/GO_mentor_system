...
const MentorLogin = () => {
  return (
    <div className="w-full h-[832px] relative bg-white">
      ...
      <div className="left-[553px] top-[150px] absolute text-red-500 text-[24px] font-semibold">
        Mentor Sign in
      </div>
        ...
        <form>
          ...
          <div className="w-[312px] h-[200.95px] left-0 top-[91.78px] absolute flex-col justify-start items-center gap-8 inline-flex">
            <div className="flex-col justify-start items-end gap-2 flex">
              ...
              <p className="text-stone-500 text-[10px] font-normal">
                Forgot password?
              </p>
            </div>
            <div className="flex-col justify-start items-center gap-4 flex">
              <div className="w-[272px] h-[41.30px] relative">
                ...
                <div className="left-[104px] top-[9px] absolute text-white text-[16px] font-bold tracking-widest">
                  Sign in
                </div>
              </div>
              <div>
                ...
                <Link to="/mentorSignup" className="text-violet-950 text-[16px] font-normal">
                  Sign up
                </Link>
              </div>
            </div>
